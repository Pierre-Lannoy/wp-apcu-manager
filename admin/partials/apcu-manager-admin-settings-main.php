...
<div class="wrap">
	...
	<h2 class="nav-tab-wrapper">
		...
		<?php if ( class_exists( 'APCuManager\Plugin\Feature\Wpcli' ) ) { ?>
            <a href="
            <?php
			echo esc_url(
				add_query_arg(
	...
	<?php if ( 'wpcli' === $active_tab ) { ?>
		<?php wp_enqueue_style( APCM_ASSETS_ID ); ?>
		<?php echo do_shortcode( '[apcm-wpcli]' ); ?>
	<?php } ?>
</div>
<div style="min-height: 100px; position: fixed; bottom: 4vh; right: 2vw; z-index: 10000">
